   ...
   <>
      ...
      <header className='bg-gray-900 text-white py-4 px-6 shadow-lg'>
        <div className="container mx-auto  px-6 flex justify-between items-center">
          <h1 className='text-2xl font-bold p-2 px-4 bg-white text-black rounded-md'>GIRI</h1>
...
{/* https://amarkumarshaw.com/assets/amr_kmr_shw_compressed_logo-CkZRtNhv.png */}
              <div className='p-4  rounded-lg  transition transform duration-500'>
                <div className='w-full ' data-aos="fade-left" data-aos-duration="1000">
                  <img src="https://via.placeholder.com/400" alt="" className='rounded-lg shadow-md'/>
              </div>
              </div>
            </div>
            </div>
        ...
        <section className="container text-center mb-10 py-3">
          <h2 className="text-2xl mb-8 text-center">Get In Touch</h2>
          <p className="py-2">North Subhas Pally Dankuni Hooghly, 712311</p>
          <p className="py-2">+91 8100033461</p>
          <p className="py-2">shawamar011@gmail.com</p>
        </section>
